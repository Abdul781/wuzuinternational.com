...
const view_btns = document.querySelectorAll(".view_btn");
const v_frames = document.querySelectorAll("#video_frame");

view_btns.forEach((view_btn)=>{
  view_btn.addEventListener("click", ()=>{
    v_frames.forEach((v_frame)=>{
      v_frame.classList.add("d-block")
    })
  })
})